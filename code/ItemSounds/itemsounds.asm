...
org $84E0B3			;Energy Tank
	DW SOUNDFX	;Load sound from SPECIALFX ;Originally DW SPECIALFX
	DB !BubbleA	;Run the "energy" sound ;Originally DB !Energy
org $84E0D8			;Missile
	DW SOUNDFX	;Load sound from SOUNDFX
	DB !BubbleA	;Run the "click" sound ;Originally DB !Click
org $84E0FD			;Super Missile
	DW SOUNDFX
	DB !BubbleA	;Originally DB !Click
...
org $84E43F			;Reserve Tank
	DW SOUNDFX		;Originally DW SPECIALFX
	DB !BubbleA	;Originally DB !Energy
